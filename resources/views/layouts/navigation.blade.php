            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-1">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('shape')">
                                {{ __('Shapes') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('remote')">
                                {{ __('Remotes') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('line')">
                                {{ __('Line') }}
                            </x-dropdown-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-1">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('product.price')">
                                {{ __('Price') }}
                            </x-dropdown-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-1">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('lightbox')">
                                {{ __('LightBoxes') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('lightbox.orders')">
                                {{ __('Orders') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-1">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('blogs.show')">
                                {{ __('All Blogs') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('images.blog')">
                                {{ __('Images') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('searches')" :active="request()->routeIs('searches')">
                        {{ __('Searches') }}
                    </x-nav-link>
                </div>
