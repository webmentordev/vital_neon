...
@section('content')
    ...
    <section class="bg-light">
        <div class="max-w-6xl m-auto py-[120px] relative z-10 overflow-x-hidden px-4">
            ...
            <div class="grid grid-cols-2 1045px:grid-cols-1 1045px:max-w-xl m-auto gap-6 bg-dark bg-opacity-80 backdrop-blur-lg p-12 600px:p-3 rounded-lg shadow-md text-white" x-data="{ placeholder: 'Type here...', text: 'Your Text' }">
