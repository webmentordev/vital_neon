<section class="w-full px-4">
    <div class="max-w-7xl m-auto py-[100px]">
        <div class="text-center mb-6 border-b border-gray-200 py-3">
            <h4 class="text-[34.5px] uppercase mb-3 text-black font-bold flex text-9xl justify-center items-center m-auto featured">Featured Products</h4>
        </div>
        <div class="grid grid-cols-4 gap-6 m-auto 1170px:grid-cols-3 940px:grid-cols-2 940px:max-w-2xl 620px:grid-cols-1 620px:max-w-[390px]">
            @foreach ($products as $item)
                <a href="{{ route('listing', $item->slug) }}" class="overflow-hidden bg-gray-200 p-3 rounded-lg group transition-all">
