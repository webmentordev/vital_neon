    ...
    <div class="max-w-4xl m-auto py-[60px] grid grid-cols-2 gap-6 border-b border-white/10 475px:grid-cols-1">
        <div class="flex flex-col">
            ...
            <ul class="flex items-center">
                <a class="mr-4" href="https://www.instagram.com/vitalneons" rel="nofollow" target="_blank"><img src="https://api.iconify.design/skill-icons:instagram.svg?color=%23f91a1a" width="25" alt="Social Media Icon"></a>
