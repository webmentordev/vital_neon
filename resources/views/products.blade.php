    ...
    <section class="w-full px-4">
        <div class="max-w-7xl m-auto py-[80px]">
            <div class="text-center mb-6 border-b border-gray-300 py-3">
                <h4 class="text-[34.5px] uppercase mb-3 text-black font-bold flex text-5xl justify-center items-center m-auto choose 490px:text-2xl">Our Products Listing</h4>
            </div>
