    ...
    <div class="max-w-4xl m-auto py-[80px]">
        ...
        @foreach ($product as $item)
            <div class="flex rounded-lg mb-6 overflow-hidden">
                <img src="{{ asset('storage/'.$item->image) }}" class="max-w-[450px] w-full" alt="Buy {{ $item->name }}">
                <div class="bg-light p-6 w-full bottom-0 left-0 max-h-[450px] overflow-y-scroll">
