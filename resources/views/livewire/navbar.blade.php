    ...
    <div class="flex items-center justify-between max-w-[90%] m-auto w-full px-2">
        ...
        <ul class="flex items-center uppercase 1340px:hidden">
            ...
            <div class="mx-4 relative group">
                <span class="category flex items-center">Categories <img src="https://api.iconify.design/ic:outline-arrow-drop-down.svg?color=%23000000" width="28" alt="Carret Down Logo"></span>
            ...
            <div class="mx-4 relative group">
                <span class="category flex items-center">Support <img src="https://api.iconify.design/ic:outline-arrow-drop-down.svg?color=%23000000" width="28" alt="Carret Down Logo"></span>
            ...
            <a href="{{ route('carts') }}" class="relative">
                <img src="https://api.iconify.design/ion:md-basket.svg?color=%23000000" width="30" alt="Cart">
            ...
            <div class="fixed top-0 left-0 w-full h-screen bg-dark backdrop-blur-lg flex justify-center items-center z-50" x-show="open" x-on:click.self="open = !open">
                <ul class="text-center flex flex-col">
                    ...
                    <div class="mx-4 relative mt-2" x-data="{toggle: false}">
                        <span class="flex items-center category text-3xl p-3 bg-light rounded-lg" x-on:click="toggle = !toggle">Categories <img src="https://api.iconify.design/ic:outline-arrow-drop-down.svg?color=%23000000" width="28" alt="Carret Down Logo"></span>
                    ...
                    <div class="mx-4 relative mb-3" x-data="{toggle: false}">
                        <span class="flex items-center category text-3xl p-3 bg-light rounded-lg" x-on:click="toggle = !toggle">Support <img src="https://api.iconify.design/ic:outline-arrow-drop-down.svg?color=%23000000" width="28" alt="Carret Down Logo"></span>
                        <div class="flex flex-col" x-show="toggle">
